...
export const data: dataType = [
    ...
    },
    {
        ...
        img: '/assets/images/pages/Article-card-image',        link: '/news/2',
        linkText: '了解更多'
    },
    {
    ...
    {
        title: 'CustomerCare - 客戶關係管理',        date: '2025-12-24',
    ...
    },
    {
        ...
        date: '2025-12-24',        breif: '環保永續的科技解決方案，協助企業實現碳中和目標。提供碳足跡追蹤、能源效率優化、綠色供應鏈管理、永續報告生成等功能，結合 IoT 感測器和 AI 分析技術，幫助企業建立環保營運模式，符合 ESG 標準並提升品牌形象。',
        label: '科技與製造',
